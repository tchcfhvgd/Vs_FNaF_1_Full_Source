...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	public var buttonB1:FlxButton = new FlxButton(0, 0);
		...
		switch (Action)
		{
			...
			case B:
				add(buttonB = createButton(FlxG.width - 132, FlxG.height - 135, 'b', 0xFFCB00));
                        case B1:
				add(buttonB1 = createButton(FlxG.width - 132, FlxG.height - 135, 'b', 0xFFCB00));
			case A_B:
	...
	override public function destroy():Void
	{
		...
		buttonB1 = FlxDestroyUtil.destroy(buttonB1);
